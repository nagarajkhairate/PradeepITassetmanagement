...
describe('<AppLink/> component', () => {
  ...
  it('supports .className property', () => {
    const text = 'internal link with specific class';
    const url = '/internal-link-with-class';
  ...
  it('supports .underline property', () => {
    ...
    ['hover', 'always', 'none'].forEach((underline) => {
      const text = `link with .underline == "${underline}"`;
      const url = '/internal-link-with-underline';
      render(
