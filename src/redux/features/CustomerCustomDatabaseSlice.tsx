...
export const addCustomerCustomDatabase = createAsyncThunk('customerCustomDatabase/addCustomerCustomDatabase', async (customerCustomDatabase: any) => {
 const response = await axios.post(`${REACT_APP_BASE_API_KEY}tenant/${REACT_APP_TENANT_ID}/custom-employee-persons`, customerCustomDatabase);
...
export const updateCustomerCustomDatabase = createAsyncThunk('customerCustomDatabase/updatecustomerCustomDatabase', async (updatedCustomerCustomDatabase: any) => {
  ...
  const response = await axios.put(`${REACT_APP_BASE_API_KEY}tenant/${REACT_APP_TENANT_ID}/custom-employee-persons/${updatedCustomerCustomDatabase.id}`, updatedCustomerCustomDatabase);
