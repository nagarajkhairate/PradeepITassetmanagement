...
export const addMaintenanceDatabase = createAsyncThunk('maintenanceDatabase/addMaintenanceDatabase', async (maintenanceDatabase: any) => {
 const response = await axios.post(`${REACT_APP_BASE_API_KEY}tenant/${REACT_APP_TENANT_ID}/employee-persons`, maintenanceDatabase);
...
export const updateMaintenanceDatabase = createAsyncThunk('maintenanceDatabase/updateMaintenanceDatabase', async (updatedMaintenanceDatabase: any) => {
  ...
  const response = await axios.put(`${REACT_APP_BASE_API_KEY}tenant/${REACT_APP_TENANT_ID}/employee-persons/${updatedMaintenanceDatabase.id}`, updatedMaintenanceDatabase);
