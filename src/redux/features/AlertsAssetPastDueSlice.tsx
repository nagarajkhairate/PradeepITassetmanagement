...
export const addAlertsAssetPastDue = createAsyncThunk('alertsAssetPastDue/addAlertsAssetPastDue', async (alertsAssetPastDue: any) => {
 const response = await axios.post(`${REACT_APP_BASE_API_KEY}tenant/${REACT_APP_TENANT_ID}/custom-asset`, alertsAssetPastDue);
...
export const updateAlertsAssetPastDue = createAsyncThunk('alertsAssetPastDue/updateAlertsAssetPastDue', async (updatedAlertsAssetPastDue: any) => {
  ...
  const response = await axios.put(`${REACT_APP_BASE_API_KEY}tenant/${REACT_APP_TENANT_ID}/custom-asset/${updatedAlertsAssetPastDue.id}`, updatedAlertsAssetPastDue);
