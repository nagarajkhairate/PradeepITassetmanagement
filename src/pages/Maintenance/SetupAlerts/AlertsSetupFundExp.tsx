...
export const AlertsSetupFundExp: React.FC = () => {
  ...
  const columns = [
    {
      title: 'Fund Expiring Alerts',
      description: 'Show alerts for expiring funds.',
      value: 'column1',
    },
    {
      title: 'Email Alerts',
...
export default React.memo(AlertsSetupFundExp)
