...
import { Typography, Box, Button, Grid, Checkbox, Modal, Input, Table, Chip, Divider, Sheet } from "@mui/joy";
...
import LeaseReturnForm from "./LeaseReturnForm";
  ...
  return (
    <AppView>
      <Box sx={{
        ...
        >
 <Typography level="h4">Lease-Return</Typography>        
        <Button
          onClick={handleOpen}
          sx={{
      ...
      {selectedAssets && selectedAssets.length > 0 ? (
        <LeaseReturnForm selectedAssets={selectedAssets} />
      ) : (
        <Box>
          <MaintenanceEmpty />
        </Box>
