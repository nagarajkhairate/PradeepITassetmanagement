...
//   id: number; // Include this property
//   locationName: Location[]; // Include this property
//   handleClose: () => void; // Include this property
//   handleClickOpen: () => void; // Include this property
// }
