...
interface AddCustomCommonComponentProps {
  open: boolean
  setOpen: (open: boolean) => void
  dispatchAction: (formData: any) => void
  title: string
}

const AddCustomCommonComponent: React.FC<AddCustomCommonComponentProps> = ({
  open,
  setOpen,
  dispatchAction,
  title,
...
export default React.memo(AddCustomCommonComponent)
