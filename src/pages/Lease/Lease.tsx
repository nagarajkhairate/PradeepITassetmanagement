...
import { Typography, Box, Button, Grid, Checkbox, Modal, Input, Table, Divider, Sheet, Chip } from "@mui/joy";
...
const Lease: React.FC = () => {
  ...
  return (
    <AppView>
      ...
      >
        <Typography level="h4">Lease</Typography>
        <Button
      ...
      {selectedAssets && selectedAssets.length > 0 ? (
        <LeaseForm selectedAssets={selectedAssets} />
      ) : (
        <Box>
          <MaintenanceEmpty />
        </Box>
